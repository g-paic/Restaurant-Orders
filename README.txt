...
Prije pokretanja aplikacije, u naredbenom retku je također prvo potrebno dodati migraciju i ažurirati bazu podataka
kroz naredbe "dotnet tool install --global dotnet-ef", "dotnet ef migrations add NameOfYourMigration" i "dotnet ef database update".
